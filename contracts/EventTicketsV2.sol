...
contract EventTicketsV2 {
    ...
    */
    modifier onlyTheOwner { require(msg.sender == owner);_;
    }
    ...
    */
    function addEvent(string memory description, string memory website, uint256 totalTickets) onlyTheOwner public returns (uint) {
        uint eventId = idTracker;
    ...
    /*
        ...
        The function returns information about the event this order:
            ...
            5. isOpen
    */
    function readEvent(uint256 eventId) public view returns (string memory description, string memory website, uint256 ticketsAvailable, uint256 sales, bool isOpen) {
        return (events[eventId].description,events[eventId].website, (events[eventId].totalTickets - events[eventId].sales), events[eventId].sales, events[eventId].isOpen);
    } 
    ...
    */
    function buyTickets(uint eventId, uint numberOfTickets) payable public {
        uint totalPayable = numberOfTickets * PRICE_TICKET;
    ...
    */
    function getRefund(uint eventId) public {
        uint numberOfTickets = getBuyerNumberTickets(eventId);
        uint totalPayable = numberOfTickets * PRICE_TICKET;
    ...
    */
    ...
    /*
        ...
        TODO:
            ...
            - emit the appropriate event
    */
    function endSale(uint eventId) onlyTheOwner public {
        uint totalPayable = events[eventId].sales * PRICE_TICKET;
